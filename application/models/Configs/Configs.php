...
* Version     : 1.1
* Update      : 28 Nov 2020
* Facebook    : https://www.facebook.com/yohandara.zx
...
{$this->yellow} -(  {$this->red}FACEBOOK{$this->yellow} | {$this->red}BOT{$this->yellow}  |  @@\  {$this->reset}| {$this->yellow}* AUTHOR : Yohandara MW
{$this->yellow}   \         /'.____.'\___|  {$this->reset}| {$this->yellow}* GIT    : github.com/yhn-zx
{$this->yellow}    '-.....-' __/ | \   (`)  {$this->reset}|----------------------------
