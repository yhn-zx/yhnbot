...
* Version     : 1.1
* Update      : 28 Nov 2020
* Facebook    : https://www.facebook.com/yohandarazx
* Telegram    : https://t.me/yohandarazx
* Whatsapp    : https://wa.me/+1(916)656-1937
* Donate      : Ovo/Dana (6281233431076)
*
  ...
  */
  ...
  private function logout()
  {
    ...
    if (strtolower($input) == 'y')
    {
      ...
      $this->climate->br()->out('  Cookies sukses terhapus');
      sleep(3);
      $this->cek_session();
    }
    else
  ...
  private function about_tools()
  {
    ...
    $this->climate->out('  Author          : Yohandara MW');
    $this->climate->out('  First version   : 1.1');
    $this->climate->out('  Current version : '.$this->current_version);
    $this->climate->out('  Release         : 30 may 2020');
    $this->climate->out('  Update          : 28 Nov 2020');
    ...
    $this->climate->out('                    +------------------------------------+');
    $this->climate->out("  Donate          : Ovo/Dana ({$this->green}6281233431076{$this->reset})");
    $this->climate->out('  Contact         : +------------------------------------+');
    $this->climate->out("                    * Facebook ({$this->green}https://www.facebook.com/yohandara.zx{$this->reset})");
    $this->climate->out("                    * Telegram ({$this->green}https://t.me/yohandarazx{$this->reset})");
    $this->climate->out("                    * Whatsapp ({$this->green}https://wa.me/+1(916)656-1937{$this->reset})");
    $this->climate->out('                    +------------------------------------+');
  ...
  {
    $response = file_get_contents('https://raw.githubusercontent.com/yhn-zx/bot-fb/master/version.txt');
  ...
  public function menu()
  {
    ...
    $this->climate->out('  +------------------------------------------------------+');
    $this->climate->out("    [{$this->yellow}RC{$this->reset}]. Hapus Cookies");
